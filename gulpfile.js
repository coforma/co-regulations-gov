...
const PROJECT_SASS_SRC = "./app/styles";

// Images destination
const IMG_DEST = "./app/public/images";

// Fonts destination
const FONTS_DEST = "./app/public/fonts";

// Compiled CSS destination
const CSS_DEST = "./app/public/css";
...
gulp.task("copy-uswds-setup", () => {
  return gulp
    ...
    .pipe(gulp.dest(`${PROJECT_SASS_SRC}/theme`));
});
